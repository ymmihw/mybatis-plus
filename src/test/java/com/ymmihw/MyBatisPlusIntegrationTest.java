...
import com.ymmihw.codegenerator.MyBatisPlusCodeGenerator;
import com.ymmihw.entity.Client;
import com.ymmihw.idgenerator.TimestampIdGenerator;
...
public class MyBatisPlusIntegrationTest {
    ...
    public void givenClientExists_whenListIsInvoked_thenClientsAreRead() {
        assertEquals(6, clientService.list().size());
    }
    ...
    public void givenClientExists_whenUsingRemovedByIdWithDeleted_thenClientIsLogicallyDeleted() {
        ...
        QueryWrapper<Client> clientQueryWrapper = new QueryWrapper<>();
        clientQueryWrapper.allEq(map);
        Client harry = clientService.getBaseMapper().selectOne(clientQueryWrapper);
    ...
    public void givenClientObject_whenNextIdIsInvoked_thenCustomIdGeneratorIsUsed() {
        ...
        assertThat(timestampIdGenerator.nextId(harry)).describedAs("Since we've used the timestampIdGenerator, the nextId value is greater than the previous Id").isGreaterThan(harry.getId());
    }
    ...
    public void givenMyBatisPlusCodeGenerator_whenGenerateCodeIsInvoked_thenCodeFilesAreGenerated() {
        ...
        List<String> codeFiles = Arrays.asList("src/main/java/com/ymmihw/entity/Client.java", "src/main/java/com/ymmihw/mapper/ClientMapper.java", "src/main/java/com/ymmihw/service/ClientService.java", "src/main/java/com/ymmihw/service/impl/ClientServiceImpl.java");
